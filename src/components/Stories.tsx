        ...
        {stories.map((story, i) => (
          <div key={i} className="grid md:grid-cols-2 gap-10 md:gap-24 items-center mb-20 md:mb-32 last:mb-0">
            ...
            <div className={story.flip ? 'md:order-1' : ''}>
              ...
              <a 
                href={`https://wa.me/919999999999?text=Hello%2C+I+am+interested+in+the+${encodeURIComponent(story.title)}`} 
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 text-[0.65rem] font-medium tracking-[0.2em] uppercase text-terra border-b border-border pb-2 group transition-all cursor-none"
              >
